...
-- Write SQL query here
SELECT c.name FROM countries c JOIN countrylanguages cl ON c.code = cl.countrycode WHERE cl.isofficial = 'T' GROUP BY c.name, cl.countrycode
HAVING COUNT(*) = 1 AND SUM(CASE WHEN cl.language = 'Italian' THEN 1 ELSE 0 END) = 1;
